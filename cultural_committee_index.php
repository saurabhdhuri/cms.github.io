...
<head>
  ...
  <?php
    ...
    include "cultural_committee_nav.php";

    $row1 = "SELECT `event_name`, `event_description`, `event_date_from`, `event_date_to` FROM `event` WHERE `committee_id` = '3'";
...
<body>
  <div class="main_body">
    <h1 class="txt_committee_name"> Cultural Committee: </h1>
