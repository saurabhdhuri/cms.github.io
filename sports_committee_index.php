...
<head>
  ...
  <?php
    ...
    include "sports_committee_nav.php";

    $row1 = "SELECT `event_name`, `event_description`, `event_date_from`, `event_date_to` FROM `event` WHERE `committee_id` = '7'";
    $re1 = mysqli_query($DBcon, $row1);
  ?>

<body>
  <div class="main_body">
    <h1 class="txt_committee_name"> Sports Committee: </h1>
